...
if __name__ == "__main__":
    ...
    actor_optimizers = [
        VIOptimizer(actor.parameters(), lr=args.learning_rate_actor, tau=args.vi_tau)
        for actor in actors
    ]
    ...
    while step < args.total_timesteps:
        ...
        # memory before the next rollout collection. Without this, the previous
        # iteration's tensors and the new ones can coexist briefly and double RAM.
